...
import {
  ...
  Zap, Globe, Database, Terminal, Command,
} from "lucide-react";
...
export const LANGUAGES: Language[] = [
  ...
  { name: "Python",      pct: 22, color: "#8B5CF6" },
...
export const ATTRIBUTES: AttributeCard[] = [
  { icon: Globe,    label: "Systems Thinking", desc: "Architecture-first approach to every problem",   accent: "#3B82F6" },
  { icon: Zap,      label: "Velocity",          desc: "From zero to shipped in record time",            accent: "#8B5CF6" },
  { icon: Database, label: "Data-Driven",       desc: "Every decision backed by metrics and evidence",  accent: "#3B82F6" },
  { icon: Terminal, label: "CLI Native",         desc: "At home in the terminal as much as the browser", accent: "#8B5CF6" },
];
